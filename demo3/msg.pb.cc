...
const uint32_t TableStruct_msg_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::msg::MyMessage, id_),
  PROTOBUF_FIELD_OFFSET(::msg::MyMessage, name_),
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::msg::_MyMessage_default_instance_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_msg_2eproto = {
  false, false, 63, descriptor_table_protodef_msg_2eproto, "msg.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "msg.MyMessage.name"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
template<> PROTOBUF_NOINLINE ::msg::MyMessage* Arena::CreateMaybeMessage< ::msg::MyMessage >(Arena* arena) {
